...
//	}
	...
	public static String  getCellValueU1 (int rownum, int colnum) {
		try {
			projectPath=System.getProperty("user.dir");
	...
	public static String getCellValueP1(int rownum, int colnum) {
		try {
	...
	public static String getCellValueU2(int rownum, int colnum) {
		try {
			projectPath=System.getProperty("user.dir");
			workBook=new XSSFWorkbook (projectPath +"/excel/LoginDetails.xlsx");
			sheet=workBook.getSheet("Sheet1");
	...
	public static String getCellValueP2(int rownum, int colnum) {
		try {
